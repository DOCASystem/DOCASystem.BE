...
public class FirebaseService: BaseService<FirebaseService>, IFirebaseService
{
    ...
    public FirebaseService(IUnitOfWork<DOCADbContext> unitOfWork,Logger<FirebaseService> logger, IMapper mapper, IHttpContextAccessor httpContextAccessor, 
        IConfiguration configuration, HttpClient httpClient) : base(unitOfWork,logger, mapper, httpContextAccessor, configuration)
    {
